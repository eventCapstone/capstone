...
public interface Consts {
   ...
   */
  public static final String PROJECT_ID = "angles-event-765";

  /**
   * Set Project Number of your Google APIs Console Project.
   */
  public static final String PROJECT_NUMBER = "156473303619";

  /**
   * Set your Web Client ID for authentication at backend.
   */
  public static final String WEB_CLIENT_ID = "156473303619.apps.googleusercontent.com";
