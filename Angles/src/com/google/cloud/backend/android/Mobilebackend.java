...
public class Mobilebackend extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Delete extends MobilebackendRequest<com.google.cloud.backend.android.EntityDto> {
    ...
    protected Delete(java.lang.String kind, java.lang.String id) {
      super(Mobilebackend.this, "DELETE", REST_PATH, null, com.google.cloud.backend.android.EntityDto.class);
   ...
   *
   * @param content the {@link com.google.cloud.backend.android.EntityListDto}
   * @return the request
   */
  public DeleteAll deleteAll(com.google.cloud.backend.android.EntityListDto content) throws java.io.IOException {
    DeleteAll result = new DeleteAll(content);
    initialize(result);
    return result;
  }

  public class DeleteAll extends MobilebackendRequest<com.google.cloud.backend.android.EntityListDto> {
     ...
     * @since 1.13
     */
    protected DeleteAll(com.google.cloud.backend.android.EntityListDto content) {
      super(Mobilebackend.this, "POST", REST_PATH, content, com.google.cloud.backend.android.EntityListDto.class);
    }
  ...
  public class Get extends MobilebackendRequest<com.google.cloud.backend.android.EntityDto> {
    ...
    protected Get(java.lang.String kind, java.lang.String id) {
      super(Mobilebackend.this, "GET", REST_PATH, null, com.google.cloud.backend.android.EntityDto.class);
      this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
  ...
  public GetE getEvent(java.lang.String kind, java.lang.String id) throws java.io.IOException {
	    GetE result = new GetE(kind, id);
	    initialize(result);
	    return result;
	  }

	  public class GetE extends MobilebackendRequest<com.google.cloud.backend.android.AnglesEventDto> {
	     ...
	     * @since 1.13
	     */
	    protected GetE(java.lang.String kind, java.lang.String id) {
	      super(Mobilebackend.this, "GET", REST_PATH, null, com.google.cloud.backend.android.AnglesEventDto.class);
	      this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
	      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
	    }
	    ...
	    @Override
	    public GetE setAlt(java.lang.String alt) {
	      return (GetE) super.setAlt(alt);
	    }

	    @Override
	    public GetE setFields(java.lang.String fields) {
	      return (GetE) super.setFields(fields);
	    }

	    @Override
	    public GetE setKey(java.lang.String key) {
	      return (GetE) super.setKey(key);
	    }

	    @Override
	    public GetE setOauthToken(java.lang.String oauthToken) {
	      return (GetE) super.setOauthToken(oauthToken);
	    }

	    @Override
	    public GetE setPrettyPrint(java.lang.Boolean prettyPrint) {
	      return (GetE) super.setPrettyPrint(prettyPrint);
	    }

	    @Override
	    public GetE setQuotaUser(java.lang.String quotaUser) {
	      return (GetE) super.setQuotaUser(quotaUser);
	    }

	    @Override
	    public GetE setUserIp(java.lang.String userIp) {
	      return (GetE) super.setUserIp(userIp);
	    }
	    ...
	    public GetE setKind(java.lang.String kind) {
	      this.kind = kind;
	      return this;
	    }
	    ...
	    public GetE setId(java.lang.String id) {
	      this.id = id;
	      return this;
	    }

	    @Override
	    public GetE set(String parameterName, Object value) {
	      return (GetE) super.set(parameterName, value);
	    }
	  }
   ...
   * @return the request
   */
  public GetAll getAll(com.google.cloud.backend.android.EntityListDto content) throws java.io.IOException {
    GetAll result = new GetAll(content);
    initialize(result);
    return result;
  }

  public class GetAll extends MobilebackendRequest<com.google.cloud.backend.android.EntityListDto> {
     ...
     * @since 1.13
     */
    protected GetAll(com.google.cloud.backend.android.EntityListDto content) {
      super(Mobilebackend.this, "POST", REST_PATH, content, com.google.cloud.backend.android.EntityListDto.class);
    }
   ...
   *
   * @param kind
   * @param content the {@link com.google.cloud.backend.android.EntityDto}
   * @return the request
   */
  public Insert insert(java.lang.String kind, com.google.cloud.backend.android.EntityDto content) throws java.io.IOException {
    Insert result = new Insert(kind, content);
    initialize(result);
    return result;
  }

  public class Insert extends MobilebackendRequest<com.google.cloud.backend.android.EntityDto> {
     ...
     * @since 1.13
     */
    protected Insert(java.lang.String kind, com.google.cloud.backend.android.EntityDto content) {
      super(Mobilebackend.this, "POST", REST_PATH, content, com.google.cloud.backend.android.EntityDto.class);
      this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
    }
  ...
  public InsertAngleEvent insertAngleEvent(java.lang.String kind, com.google.cloud.backend.android.AnglesEventDto content) throws java.io.IOException {
	  InsertAngleEvent result = new InsertAngleEvent(kind, content);
	    initialize(result);
	    return result;
	  }

	  public class InsertAngleEvent extends MobilebackendRequest<com.google.cloud.backend.android.AnglesEventDto> {
	     ...
	     * @since 1.13
	     */
	    protected InsertAngleEvent(java.lang.String kind, com.google.cloud.backend.android.AnglesEventDto content) {
	      super(Mobilebackend.this, "POST", REST_PATH, content, com.google.cloud.backend.android.AnglesEventDto.class);
	      this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
	    }

	    @Override
	    public InsertAngleEvent setAlt(java.lang.String alt) {
	      return (InsertAngleEvent) super.setAlt(alt);
	    }

	    @Override
	    public InsertAngleEvent setFields(java.lang.String fields) {
	      return (InsertAngleEvent) super.setFields(fields);
	    }

	    @Override
	    public InsertAngleEvent setKey(java.lang.String key) {
	      return (InsertAngleEvent) super.setKey(key);
	    }

	    @Override
	    public InsertAngleEvent setOauthToken(java.lang.String oauthToken) {
	      return (InsertAngleEvent) super.setOauthToken(oauthToken);
	    }

	    @Override
	    public InsertAngleEvent setPrettyPrint(java.lang.Boolean prettyPrint) {
	      return (InsertAngleEvent) super.setPrettyPrint(prettyPrint);
	    }

	    @Override
	    public InsertAngleEvent setQuotaUser(java.lang.String quotaUser) {
	      return (InsertAngleEvent) super.setQuotaUser(quotaUser);
	    }

	    @Override
	    public InsertAngleEvent setUserIp(java.lang.String userIp) {
	      return (InsertAngleEvent) super.setUserIp(userIp);
	    }

	    @com.google.api.client.util.Key
	    private java.lang.String kind;

	    public InsertAngleEvent set(String parameterName, Object value) {
	        return (InsertAngleEvent) super.set(parameterName, value);
	    }
	    public java.lang.String getKind() {
	      return kind;
	    }

	    public InsertAngleEvent setKind(java.lang.String kind) {
	      this.kind = kind;
	      return this;
	    }
   ...
   * @return the request
   */
  public InsertAll insertAll(com.google.cloud.backend.android.EntityListDto content) throws java.io.IOException {
    InsertAll result = new InsertAll(content);
    initialize(result);
    return result;
  }

  public class InsertAll extends MobilebackendRequest<com.google.cloud.backend.android.EntityListDto> {
     ...
     * @since 1.13
     */
    protected InsertAll(com.google.cloud.backend.android.EntityListDto content) {
      super(Mobilebackend.this, "POST", REST_PATH, content, com.google.cloud.backend.android.EntityListDto.class);
    }
   ...
   *
   * @param content the {@link com.google.cloud.backend.android.QueryDto}
   * @return the request
   */
  public List list(com.google.cloud.backend.android.QueryDto content) throws java.io.IOException {
    List result = new List(content);
    initialize(result);
    return result;
  }

  public class List extends MobilebackendRequest<com.google.cloud.backend.android.EntityListDto> {
     ...
     * @since 1.13
     */
    protected List(com.google.cloud.backend.android.QueryDto content) {
      super(Mobilebackend.this, "POST", REST_PATH, content, com.google.cloud.backend.android.EntityListDto.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.String kind, java.lang.String id, com.google.cloud.backend.android.EntityDto content) throws java.io.IOException {
    Patch result = new Patch(kind, id, content);
    initialize(result);
    return result;
  }

  public class Patch extends MobilebackendRequest<com.google.cloud.backend.android.EntityDto> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.String kind, java.lang.String id, com.google.cloud.backend.android.EntityDto content) {
      super(Mobilebackend.this, "PATCH", REST_PATH, content, com.google.cloud.backend.android.EntityDto.class);
      this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.String kind, com.google.cloud.backend.android.EntityDto content) throws java.io.IOException {
    Update result = new Update(kind, content);
    initialize(result);
    return result;
  }

  public class Update extends MobilebackendRequest<com.google.cloud.backend.android.EntityDto> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.String kind, com.google.cloud.backend.android.EntityDto content) {
      super(Mobilebackend.this, "POST", REST_PATH, content, com.google.cloud.backend.android.EntityDto.class);
      this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
    }
   ...
   * @return the request
   */
  public UpdateAll updateAll(com.google.cloud.backend.android.EntityListDto content) throws java.io.IOException {
    UpdateAll result = new UpdateAll(content);
    initialize(result);
    return result;
  }

  public class UpdateAll extends MobilebackendRequest<com.google.cloud.backend.android.EntityListDto> {
     ...
     * @since 1.13
     */
    protected UpdateAll(com.google.cloud.backend.android.EntityListDto content) {
      super(Mobilebackend.this, "POST", REST_PATH, content, com.google.cloud.backend.android.EntityListDto.class);
    }
